...
import ManagePromosPromosAdmin from './Screens-Admin/ManagePromosPromosAdmin'; // Importar el nuevo componente de promociones
...
function App() {
  ...
  const [isManagePromosVisible, setIsManagePromosVisible] = useState(false); // Estado para gestionar promociones
  ...
  const openManagePromos = () => {
    closeAllAdminScreens();
    setIsManagePromosVisible(true); // Abrir la pantalla de promociones
  };

  // Cerrar todas las pantallas de admin
  const closeAllAdminScreens = () => {
    ...
    setIsManagePromosVisible(false); // Cerrar la pantalla de promociones
  };
      ...
      {!isAdmin ? (
        ...
        <>
          <AdminNavbar 
            ...
            openManagePromos={openManagePromos} // Añadir promociones al AdminNavbar
          ...
          {isManagePromosVisible && <ManagePromosPromosAdmin onClose={closeAllAdminScreens} />} {/* Mostrar promociones */}
        </>
      )}
