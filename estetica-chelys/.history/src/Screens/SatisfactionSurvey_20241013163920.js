...
const SatisfactionSurvey = ({ isVisible, closeSurvey }) => {
  ...
  const timeoutRef = useRef(null); // Ref para el timeout de cierre automático
  ...
  useEffect(() => {
    // Limpiar timeout si el componente se desmonta antes de que el timeout termine
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Cerrar la encuesta después de 2 segundos
