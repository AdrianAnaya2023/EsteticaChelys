...
const ProductCatalog = () => {
  const sampleCategories = [
    ...
    { id: 4, name: 'Cuidado del Rostro', imageUrl: 'https://example.com/cuidado-rostro.jpg' },
    { id: 5, name: 'Productos Naturales', imageUrl: 'https://example.com/productos-naturales.jpg' },
  ];
      ...
      {currentCategory ? (
        <div>
          ...
          <div className="pagination-controls">
            ...
            <button onClick={() => handleProductPageChange('next')} disabled={currentPage + itemsPerPage >= sampleProducts[currentCategory.id].length}>
              Siguiente
            </button>
          </div>
