      ...
      <div className="modal-contentOfertillas">
        ...
        <div key={offers[currentOfferIndex].id} className="offer-cardOfertillas">
          ...
          <div className="offer-infoOfertillas">
            ...
            <p className="offer-end-dateOfertillas">Finaliza el: {offers[currentOfferIndex].endDate}</p> {/* Mostrar la fecha de finalización */}
          </div>
        </div>

        {/* Botón "Siguiente" para cambiar entre ofertas */}
        <button className="next-offer-buttonOfertillas" onClick={handleNextOffer}>Siguiente</button>
      </div>
    </div>
  );
};
