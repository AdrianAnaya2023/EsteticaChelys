...
const Gallery = () => {
  ...
  const handlePageChange = (direction) => {
    const totalPages = Math.ceil(sampleImages[currentCategory.id].length / itemsPerPage);
        ...
        <div>
          ...
          <div className="pagination-controls-gallerita">
            ...
            <button
              ...
              disabled={(currentPage + 1) * itemsPerPage >= sampleImages[currentCategory.id].length}
            >
              Siguiente
            </button>
          </div>
