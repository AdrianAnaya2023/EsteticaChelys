  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        console.log('Servicios cargados:', loadedServices); // Verificar datos de servicios
        console.log('Categorías cargadas:', loadedCategories); // Verificar datos de categorías
