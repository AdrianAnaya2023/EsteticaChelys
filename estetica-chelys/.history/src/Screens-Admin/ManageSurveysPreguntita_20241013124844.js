...
const ManageSurveysPreguntita = () => {
  ...
  const renderCharts = () => {
    // Verificación adicional para evitar errores con detalles o resultados vacíos o no cargados
    if (!selectedQuestion || !details.length || !results.length) return null;
