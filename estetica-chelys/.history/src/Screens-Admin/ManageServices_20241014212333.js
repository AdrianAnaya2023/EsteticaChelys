...
const ManageServices = ({ onClose }) => {
  ...
  // Cargar datos (servicios y categorías) cuando el componente se monta
  useEffect(() => {
  ...
  const handleSave = async () => {
    console.log('Datos actuales del nuevo servicio:', newItem); // Agregamos para inspeccionar los datos antes de enviarlos
